...
\section{Professional Summary}
  \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    Computer Science Engineering student, skilled in software development, networking, and cybersecurity. Proficient in C/C++, Python, and Java. Passionate about contributing to cutting-edge projects. Strong collaboration, problem-solving, and adaptability skills. Expertise in network simulation and cybersecurity.
  \end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {\href{https://g.dev/TammireddySrinivasRao_MLRITM}{Programming Lead}}{June 2020 -- Present}
