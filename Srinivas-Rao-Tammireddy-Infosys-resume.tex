...
\section{Objective}
  \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    I am a Computer Science Engineering student at MLRITM, Hyderabad. I am passionate about learning new technologies and developing software applications. I am a self-motivated individual with a strong desire to learn and grow as an Indian.
  \end{itemize}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Github, Project IDX, Visual Studio Code, PyCharm, Star UML, Google Workspace, MS Excel, MS Word.} \\
     \textbf{Technologies/Frameworks}{: Version Control System, Flutter,Data Structures and Algorithms, Material-3 Design,\LaTeX, App Script} \\
    }}
 \end{itemize}
