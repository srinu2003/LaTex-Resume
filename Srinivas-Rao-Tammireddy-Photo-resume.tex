...
\section{Experience}
    \resumeSubHeadingListStart
        ...
        \resumeItemListEnd
        \resumeSubheading
            {\href{http://kitsltd.co.uk/index.html}{Software Engineer Assistant Intern}}{June 2024 -- Dec 2024}
...
\section{Contributions}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {MLRITM Seminar Report Template}{Jan. 2024 -- Present}
      {LaTeX Template for Academic Documents}{MLRITM, Dundigal}
      \resumeItemListStart
        \resumeItem{Designed and developed a comprehensive LaTeX template for standardizing seminar reports across departments.}
        \resumeItem{Implemented proper formatting with title page, table of contents, bibliography, and section styling according to institutional guidelines.}
        \resumeItem{Created documentation and examples to help students to easily use the template.}
        \resumeItem{\href{https://www.overleaf.com/read/gbrmwggwvvny}{Overleaf Link: MLRITM-seminar-report-template}}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
%-----------INVOLVEMENT---------------
\vspace{-11pt}
