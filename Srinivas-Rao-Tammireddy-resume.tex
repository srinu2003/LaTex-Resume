...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Java, Python, Dart, C Language, *SQL, HTML \& *CSS, *PHP, *Javascript} \\
     \textbf{Developer Tools}{: *Linux, *Assembly, Git, Github, Project IDX, Visual Studio Code, PyCharm, Star UML, Jupyter Notebook, *MS Excel, MS Word.} \\
     \textbf{Technologies/Frameworks}{: Version Control System, Flutter, Material-3 Design,\LaTeX, *App Script, *Blockchain} \\
    }}
  \resumeSubheading{}{}{}{*Elimentary proficiency}
 \end{itemize}
