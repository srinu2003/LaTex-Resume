...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.Tech - CSE, 8.84(Current)/10 CGPA, Qualified GATE 2025 [CS]}{Hyderabad, IND}
    \resumeSubheading
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\href{https://github.com/srinu2003/ibcm}{{\textbf{IBCM: Image-Based Construction Monitoring}} $|$ \emph{Python, Flask, \sout{React}}}}{Jan 19, 2025 -- Present}
