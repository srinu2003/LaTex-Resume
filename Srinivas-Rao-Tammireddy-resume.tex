...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.Tech - Computer Science and Engineering, 8.94/10 CGPA}{Hyderabad, IND}
    \resumeSubheading
...
%-------------------------------------------
    ...
    \resumeSubheading{\href{http://kitsltd.co.uk/index.html}{Intern at KITS Ltd}}{June.2024}{Keertana Information Technology Solutions Limited}{KITS Ltd, UK}
      \resumeItemListStart
          \resumeItem{Working as a Database Engineer Intern, developing and maintaining databases for the company Projects.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: *Linux,, Git, Github, Project IDX, Visual Studio Code, PyCharm, Star UML, Jupyter Notebook, *MS Excel, MS Word, MySQL.} \\
     \textbf{Technologies/Frameworks}{: Flutter, Material-3 Design, \LaTeX, *App Script, *Blockchain} \\
    }}
  \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
