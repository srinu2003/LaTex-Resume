...
\section{Professional Summary}
  \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Computer Science Engineering} Computer Science Engineering graduate with demonstrated experience in both general software engineering and the Salesforce platform, passionate about developing applications. I strive to work on challenging assignments that offer job satisfaction and steady \textbf{professional growth}.}
  \end{itemize}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {\href{https://mlritm.ac.in}{Marri Laxman Reddy Institute of Technology and Management}}{Nov. 2021 -- May 2025}
      {B.Tech - CSE, 8.85/10 CGPA, Qualified GATE 2025 [CS]}{Hyderabad, IND}
    \resumeSubheading
...
\section{Experience}
  \resumeSubHeadingListStart
      \resumeSubheading
      {\href{https://bigworks.co}{Salesforce Developer – Trainee Consultant}}{June 2025 -- Present}
      {Bigworks Technologies Pvt. Ltd.}{Hyderabad, IND}
      \resumeItemListStart
        \resumeItem{Completed comprehensive Functional and Technical Salesforce training, gaining hands-on expertise in Apex, SOQL, Lightning Web Components (LWC), Salesforce Platform and Flow automation.}
        \resumeItem{Gained hands-on experience in declarative development within the Salesforce Platform.}
      \resumeItemListEnd
...
%-------------------------------------------
    ...
    %   \resumeItemListEnd
        \resumeSubheading
          {\href{http://kitsltd.co.uk/index.html}{Software Engineer Assistant Intern}}{July 2024 -- Dec 2024}
          {Keertana Information Technology Solutions Limited}{KITS Ltd, UK}
          \resumeItemListStart
          \resumeItem{Assisted in developing backend for web portals with backend support.}
          \resumeItem{Developing an analytics dashboard for the company using Streamlit.}
          \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\href{https://github.com/srinu2003/ibcm}{{\textbf{IBCM: Image-Based Construction Monitoring}} $|$ \emph{Python, Flask, \sout{React}}}}{Jan. 2025 -- May 2025}
        \resumeItemListStart \vspace{0pt}
        \resumeItem{Developed a web application for monitoring construction progress through image analysis.}
        \resumeItem{Implemented image processing algorithms to extract progress metrics from construction site photos.}
        \resumeItem{Created dashboard for schedule comparison and progress visualization.}  \resumeItemListEnd
      \resumeProjectHeading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
  % TO DO: Separete the Elementary proficiency skills from the main skills
  \small{\item{
    \textbf{Programming \& Scripting}{: Apex, SOQL, Java (Core), Python, SQL*, HTML* \& CSS*} \\
    \textbf{Developer Tools}{: Visual Studio Code, MySQL Workbench, Jira, Git, Github, Star UML, Jupyter Notebook, *MS Excel, *MS Word, *MySQL.} \\
    \textbf{Salesforce}{: Salesforce Platform, Visualforce Pages, Lightning Web Components (LWC), Flow Automation, Data Security, Experience Cloud*} \\
   }}
  \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
...
\vspace{-3pt}
  \section{Certifications/Courses}
    \resumeItemListStart[parsep = 0pt]
      ...
      \resumeItem{\href{https://drive.google.com/file/d/1w72XSRwblf5AqqEBGvnUbvUayJTcpWO-/view?usp=sharing}
                {\textbf{CLA: Programming Essentials in C} by Cisco \faExternalLink*} (Aug. 2022)}
      \resumeItem{\href{https://drive.google.com/file/d/1Hg6w58KnwbqaRiJdtpxpFh-dshw1vEoR/view?usp=sharing}
                {\textbf{UI/UX Hackathon} by MLRITM Department of C.S.E \faExternalLink*} (Sep. 2021)}
    \resumeItemListEnd
